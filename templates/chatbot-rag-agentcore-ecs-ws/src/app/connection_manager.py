...
connectionId -> userId mappings with TTL for automatic cleanup of
stale connections (24h default).

Reuses the same logic as the Lambda WebSocket variant's shared connection
manager module, adapted for direct ECS module imports.
