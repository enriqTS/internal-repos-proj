"""Shared WebSocket connection lifecycle management module.

Manages connection entries in the DynamoDB Connection_Table for WebSocket
variants (Lambda and ECS). Stores connectionId → userId mappings with TTL
for automatic cleanup of stale connections (24h default).
