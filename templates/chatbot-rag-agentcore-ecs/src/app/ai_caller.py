"""AI Caller module — AgentCore variant for ECS in-process use.

Wraps the shared AgentCore AI caller logic for direct function call use
within the ECS container. No Lambda handler wrapper needed — the orchestrator
imports and calls these functions directly.
