...
# Connection_Table configuration (WebSocket variant)
...
# Streaming configuration — max tokens per WebSocket frame (1-50)
...
POWERTOOLS_SERVICE_NAME: str = os.environ.get("POWERTOOLS_SERVICE_NAME", "chatbot-ecs-ws-streaming")
